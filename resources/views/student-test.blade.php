...
@livewireStyles
    <div class="md:container mx-auto">
        ...
        <form action="/student-test" method="post" class="m-4">
            @csrf
            <div class="py-5">
                                                    ...
                                                    <div class="flex items-center">
                                                        <label for="answer-{{ $answer->id }}"
                                                            ...
                                                            <input id="answer-{{ $answer->id }}"
                                                                   ...
                                                                   type="radio"
                                                                   value="{{$answer->id}}"
                                                                   class="focus:ring-indigo-500 mr-3 h-4 w-4 text-indigo-600 border-gray-300">
                ...
                <div class="text-center mt-1">
                    <button type="button" onclick="loadDoc()"  id="demo" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Button
                    </button>
                </div>
            </div>
