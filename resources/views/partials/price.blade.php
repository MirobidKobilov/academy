<div  id="price" class="max-w-md mx-auto mb-14 text-center">
    <h1 class="text-4xl font-semibold mb-6 lg:text-5xl"><span class="text-indigo-600">Тарифы</span> Обучения</h1>
    <p class="text-xl text-gray-500 font-medium">скоро появится контент</p>
</div>

<div class=" container mx-auto gap-5 flex flex-col justify-between items-center lg:flex-wrap lg:flex-row lg:items-start">
